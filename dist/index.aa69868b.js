...
color_option_1.addEventListener("click", ()=>{
    cycleGradients(color_option_1, color_option_2, color_option_3, "default-gradient", "purple-gradient", "green-gradient");
});
color_option_2.addEventListener("click", ()=>{
    cycleGradients(color_option_2, color_option_1, color_option_3, "purple-gradient", "default-gradient", "green-gradient");
});
color_option_3.addEventListener("click", ()=>{
    cycleGradients(color_option_3, color_option_1, color_option_2, "green-gradient", "default-gradient", "purple-gradient");
});
const cycleGradients = function(selectAdd, selectRem1, selectRem2, gradientAdd, gradientRem1, gradientRem2) {
