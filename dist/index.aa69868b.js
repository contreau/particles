...
color_option_1.addEventListener("click", ()=>{
    cycleGradients(color_option_1, color_option_2, color_option_3, "default-gradient", "blue-gradient", "green-gradient", "#fff");
});
color_option_2.addEventListener("click", ()=>{
    cycleGradients(color_option_2, color_option_1, color_option_3, "blue-gradient", "default-gradient", "green-gradient", "#373737");
});
color_option_3.addEventListener("click", ()=>{
    cycleGradients(color_option_3, color_option_1, color_option_2, "green-gradient", "default-gradient", "blue-gradient", "#fff");
});
const cycleGradients = function(selectAdd, selectRem1, selectRem2, gradientAdd, gradientRem1, gradientRem2, bg_color) {
