...
const motionOptions_Arr = Array.from(document.querySelectorAll(".motion-option"));
...
const cycleGradients = function(desired_option, desired_gradient, bg_color) {
    if (!desired_option.classList.contains("color-selected")) {
        ...
        for (let className of body.classList)if (className != "body") body.classList.remove(className);
